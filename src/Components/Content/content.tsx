...
const Content: React.FC = () => {
    ...
    return (
        <div className="content">
            ...
            />
            {openEnterMarket ? <EnterMarketDialog closeMarketDialog={closeMarketDialog} /> : null}
            {openSupplyMarketDialog ? <SupplyMarketDialog closeSupplyMarketDialog={closeSupplyMarketDialog} /> : null}
            {openBorrowMarketDialog ? <BorrowMarketDialog closeBorrowMarketDialog={closeBorrowMarketDialog} /> : null}
        </div>
    );
};
